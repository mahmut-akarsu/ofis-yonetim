...
async loadManagedPcs() : Promise<Result<ManagedPc[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("load_managed_pcs") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async saveManagedPcs(pcs: ManagedPc[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("save_managed_pcs", { pcs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async checkPcConnections(pcs: ManagedPc[]) : Promise<Result<PcConnectionStatus[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("check_pc_connections", { pcs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runRemoteCommand(pcs: ManagedPc[], command: string) : Promise<Result<RemoteOperationResult[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("run_remote_command", { pcs, command }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deployFileToPcs(pcs: ManagedPc[], localPath: string, remoteDir: string) : Promise<Result<RemoteOperationResult[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("deploy_file_to_pcs", { pcs, localPath, remoteDir }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
