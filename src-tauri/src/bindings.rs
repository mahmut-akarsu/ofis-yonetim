...
pub fn generate_bindings() -> Builder<tauri::Wry> {
    use crate::commands::{notifications, preferences, quick_pane, recovery, remote};
    ...
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        remote::load_managed_pcs,
        remote::save_managed_pcs,
        remote::check_pc_connections,
        remote::run_remote_command,
        remote::deploy_file_to_pcs,
    ])
}
